...
accidents_non_sfc <- accidents_sf |> sf::st_as_sfc()
...
p_val_med <- nrow(mc_df[mc_df$Middle >= obs_rez_counts$Middle,]) / nrow(mc_df)
p_val_med
...
cat('Morans I for Reservations:')
rez_moran$estimate[1]

cat('Morans I for Non-Reservations:')
